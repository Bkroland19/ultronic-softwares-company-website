		...
		<div className="footer grid grid-flow-dense sm:text-sm align-items:center display:flex overflow-x-hidden ">
			<div className=" mt-2 ">
				...
				<p className="text-sm my-2 justify-self-center md:text-center">
					This company was started by kizza bukenya Roland and his fellow
					developers
				</p>
			...
			<div className="mr-2 mt-2 mb-8 grid justify-items-center">
				...
				<p className="text-sm  mb-2 mx-auto p-2"></p>
				<h5>Contact Us</h5>
				<ul>
					<li>
						<PhoneIcon /> : +256708832767/+256778354423
					</li>

					<li>
						<MailOutlineIcon />: ultronicsoftwaredevs@gmail.com
					</li>
				</ul>
			</div>
