...
function Footer() {
    ...
    return (
        <div className = {`text-gray-300 bg-gray-800 py-2 p-4  
        grid  gap-4 text-sm md:text-lg grid-cols-1 md:grid-cols-3 
        place-content-start font-sans`}>
           <div className ="pr-10 mr-2 mt-2 mb-8  grid justify-items-stretch">
              <h2 className ="mb-2 text-xl justify-self-center md:justify-self-start">About us</h2> 
              ...
              <p className ="text-sm my-2 justify-self-center md:text-center" >
                 This company was started by kizza bukenya Roland and his  
                 fellow developers
             </p>
